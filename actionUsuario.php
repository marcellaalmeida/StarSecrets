...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!$erroPreenchimento && !$erroUpload){
            ...
            $inserirUsuario = "INSERT INTO Usuario (fotoUsuario, nomeUsuario, cursoUsuario, emailUsuario, senhaUsuario) VALUES ('$fotoUsuario', '$nomeUsuario', '$cursoUsuario', '$emailUsuario', '$senhaUsuario')";
